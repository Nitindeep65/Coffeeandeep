  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
      ...
      >
            ...
            <DockItem key={item.title}>
              ...
              <DockIcon>
                <a 
                  ...
                  className={`flex items-center justify-center w-full h-full rounded-lg transition-colors ${
                    isActive 
        ...
        {/* Separator */}
        <div className="w-px h-8 bg-gray-300 dark:bg-neutral-700 mx-1" />
          ...
          <DockItem key={link.title}>
            ...
            <DockIcon>
              <a 
                ...
                className="flex items-center justify-center w-full h-full rounded-lg hover:bg-gray-200 dark:hover:bg-neutral-700 text-gray-700 dark:text-gray-300 transition-colors"
              >
