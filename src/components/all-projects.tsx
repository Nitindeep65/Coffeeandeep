...
const AllProjects = ({ initialProjects = [] }: AllProjectsProps) => {
    ...
    <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        ...
        <div className="text-center mb-16">
          <Link 
            href="/"
            className="inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 mb-6 transition-colors duration-200"
          >
          ...
          <p className="text-xl text-gray-600 dark:text-zinc-400 max-w-3xl mx-auto">
            Explore my complete portfolio of projects, each showcasing different technologies and problem-solving approaches.
          </p>
        </div>
